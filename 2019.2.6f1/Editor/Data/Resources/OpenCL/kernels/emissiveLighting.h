...
static AtlasInfo FetchEmissionFromRayIntersection(
    ...
    __global float4*          const   dynarg_texture_buffer
...
)
{
    ...
    AtlasInfo atlasInfo;
    atlasInfo.color = FetchAlbedoTextureFromMaterialAndUVs(albedoTextures_buffer, textureUVs, matProperty, true KERNEL_VALIDATOR_BUFFERS);
    atlasInfo.textureUVs = textureUVs;

...
namespace UnityEditor.Timeline
{
    ...
    class ClipInspector : Editor
    {
        ...
        internal override bool IsEnabled()
        {
            ...
            if (timelineWindow.state.editSequence.isReadOnly)
                return false;

            if (m_TimelineAsset != timelineWindow.state.editSequence.asset)
                return false;
        ...
        bool IsLocked()
        {
            ...
            return targets.OfType<EditorClip>().Any(t => (t.clip.parentTrack != null && t.clip.parentTrack.lockedInHierarchy) || TimelineWindow.instance.state.editSequence.isReadOnly);
        }

        static bool IsTimelineValid()
        {
            return TimelineWindow.instance != null && TimelineWindow.instance.state != null;
        }
    }
}

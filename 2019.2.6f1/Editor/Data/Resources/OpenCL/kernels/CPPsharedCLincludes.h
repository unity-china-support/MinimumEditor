...
#define UNITY_KERNEL_INCLUDES_VERSION "201903180"
...
typedef enum radeonRaysBufferID
{
    ...
    kRRBuf_lightRayIndexToPathRayIndexBuffer,
    kRRBuf_totalRayCastBuffer,
    kRRBuf_lightRaysCountBuffer,
    kRRBuf_expandedRaysCountBuffer,
    kRRBuf_expandedTexelBuffer,
    kRRBuf_expandedTexelCountBuffer,
    kRRBuf_expandedRaysBuffer,

...
namespace UnityEditor.Timeline
{
    ...
    class TrackAssetInspector : Editor
    {
        ...
        bool IsTimelineValid()
        {
            return timelineWindow != null && timelineWindow.state != null;
        }
        ...
        protected bool IsTrackLocked()
        {
            ...
            return targets.Any(track => ((TrackAsset)track).lockedInHierarchy || timelineWindow.state.editSequence.isReadOnly);
        }
        ...
        internal override bool IsEnabled()
        {
            ...
            var sequence = timelineWindow.state.editSequence;
            return sequence != null && !sequence.isReadOnly && base.IsEnabled();
        }

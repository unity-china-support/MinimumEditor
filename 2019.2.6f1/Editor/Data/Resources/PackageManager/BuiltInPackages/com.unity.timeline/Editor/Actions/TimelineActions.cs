...
namespace UnityEditor.Timeline
{
    ...
    abstract class TimelineAction : MenuItemActionBase
    {
        ...
        protected virtual string GetDisplayName(WindowState state)
        {
        ...
        public static IEnumerable<object> GetMenuEntries(WindowState state, Vector2 mousePos)
        {
            ...
            actions.ForEach(action =>
            {
                ...
                var displayName = action.GetDisplayName(state);
                action.SetMousePosition(mousePos);
